...
var onRequestGet = /* @__PURE__ */ __name(async (context2) => {
  ...
  const sourcePage = url.searchParams.get("source") ?? (rawReferer.startsWith("https://guanacaste.tours") ? new URL(rawReferer).pathname : null);
...
// ../.wrangler/tmp/pages-ezZHYo/functionsRoutes-0.006361949357152841.mjs
var routes = [
  {
    routePath: "/go/:slug*",
    mountPath: "/go",
